"""
Django settings for matlacha_civic_40363 project.
...
ROOT_URLCONF = 'matlacha_civic_40363.urls'
...
WSGI_APPLICATION = 'matlacha_civic_40363.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "matlacha_civic_40363 API",
    "DESCRIPTION": "API documentation for matlacha_civic_40363 App",
    "VERSION": "v1",
}
